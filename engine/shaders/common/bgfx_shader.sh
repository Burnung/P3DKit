...
vec2 vec2(float _x) { return vec2(_x, _x); }
vec3 vec3(float _x) { return vec3(_x, _x, _x); }
vec4 vec4(float _x) { return vec4(_x, _x, _x, _x); }
...
uvec2 uvec2(uint _x) { return uvec2(_x, _x); }
uvec3 uvec3(uint _x) { return uvec3(_x, _x, _x); }
uvec4 uvec4(uint _x) { return uvec4(_x, _x, _x, _x); }
